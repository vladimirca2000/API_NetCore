...
namespace Api.Service.Services
{
    public class MunicipioService : IMunicipioService
    {
        ...
        public async Task<MunicipioDtoCompleta> GetCompletoById(Guid id)
        {
            var entity = await _repository.GetCompleteById(id);
            return _mapper.Map<MunicipioDtoCompleta>(entity);
        }

        public async Task<MunicipioDtoCompleta> GetCompletoByIbege(int codigoIbge)
        {
            var entity = await _repository.GetCompleteByIbge(codigoIbge);
            return _mapper.Map<MunicipioDtoCompleta>(entity);
        }
